...
maxStock: dto.stockQuantity,
    ...
    displayDiscountType: dto.displayDiscountType ?? (dto.variantId && dto.productData?.variants ? dto.productData.variants.find((v: any) => v.id === dto.variantId)?.displayDiscountType : null) ?? dto.productData?.displayDiscountType ?? "None",
    systemDiscountAmount: dto.systemDiscountAmount ?? (dto.variantId && dto.productData?.variants ? dto.productData.variants.find((v: any) => v.id === dto.variantId)?.systemDiscountAmount : null) ?? dto.productData?.systemDiscountAmount ?? 0,
    hasSystemDiscount: dto.hasSystemDiscount ?? (dto.variantId && dto.productData?.variants ? dto.productData.variants.find((v: any) => v.id === dto.variantId)?.hasSystemDiscount : null) ?? dto.productData?.hasSystemDiscount ?? false,
