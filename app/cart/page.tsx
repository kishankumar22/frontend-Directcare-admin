                    ...
                    <div className="flex flex-col flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-1.5 flex-wrap gap-1">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {/* 🔥 REMOVE BUTTON - RIGHT SIDE OF PLUS BUTTON */}
                          <button
                            onClick={() => setRemoveTarget({ item, bundleChildren })}
                            className="px-2 py-1 text-xs text-red-500 hover:text-red-700 hover:bg-red-50 rounded transition font-medium border border-red-200 hover:border-red-300 bg-white"
