...
export default function CategoryModal({
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-900 dark:bg-gradient-to-br dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 border border-violet-500/20 rounded-2xl max-w-5xl w-full max-h-[95vh] overflow-hidden shadow-xl flex flex-col">
        {/* HEADER */}
        <div className="p-3 border-b border-violet-500/20 bg-gradient-to-r from-[#8b5cf6]/10 to-[#06b6d4]/10">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                ...
                className={`w-14 h-14 rounded-lg flex items-center justify-center shrink-0 ${(formData.imageUrl || imagePreview)
              ...
              <div>
                ...
                {/* SUBTITLE */}
                <p className="text-slate-500 dark:text-slate-500 dark:text-slate-400 text-sm flex items-center gap-2">
                  {editingCategory
            ...
            <button
              ...
              className="p-2 text-slate-500 dark:text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white hover:bg-red-500/10 dark:hover:bg-red-500/20 border border-transparent hover:border-red-500/50 rounded-lg transition-all"
        ...
        <div className="flex gap-1 px-4 py-2 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50">
          {["basic", "image", "seo", "schema description", "settings", "faqs"].map((tab) => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs capitalize transition ${activeTab === tab
        ...
        >
          ...
          {activeTab === "basic" && (
            <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200 dark:border-slate-700/50 space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg text-sm text-slate-900 dark:text-white transition-all ${nameStatus === "duplicate"
                ...
                />
                {nameStatus === "checking" && (
                  <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Checking...</p>
                )}
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-white"
                />

                {/* DROPDOWN */}
                {open && (
                  <div className="absolute z-50 mt-1 w-full max-h-60 overflow-auto bg-white dark:bg-slate-900 border border-slate-700 rounded-lg shadow-lg">
                    ...
                    <div
                      ...
                      className="px-3 py-2 text-sm text-slate-500 dark:text-slate-400 hover:bg-slate-800 cursor-pointer"
                    >
                      None (Main Category)
                    </div>
            ...
            ${c.level === 1 ? "bg-slate-50 dark:bg-slate-800/40" : ""}
            ${c.level === 0 ? "font-medium text-white" : "text-slate-700 dark:text-slate-300"}
          ...
          {/* ================= IMAGE ================= */}
          {activeTab === "image" && (
            <div className="bg-slate-50 dark:bg-slate-800/40 p-3 rounded-xl border border-slate-200 dark:border-slate-700/50 space-y-3">


              <div className="space-y-4">
                {/* Current/Preview Image Display */}
                {(imagePreview || formData.imageUrl) && (
                  <div className="flex items-center gap-4 p-3 bg-slate-100 dark:bg-slate-900/30 rounded-xl border border-slate-300 dark:border-slate-600">
                    <div
                    ...
                    <div className="flex gap-2">
                      <label
                        className={`px-3 py-2 rounded-lg text-sm font-medium cursor-pointer transition-all ${!formData.name
                            ? "bg-slate-200 dark:bg-slate-700/50 text-slate-500 dark:text-slate-500 cursor-not-allowed"
                ...
                {!formData.imageUrl && !imagePreview && (
                  <div className="flex items-center justify-center w-full">
                    <label
                      className={`flex flex-col items-center justify-center w-full h-24 border-2 border-dashed rounded-xl transition-all ${!formData.name
                          ? "border-slate-700 bg-slate-50 dark:bg-slate-900/20 cursor-not-allowed"
                          : "border-slate-300 dark:border-slate-600 bg-slate-100 dark:bg-slate-900/30 hover:bg-slate-100 dark:bg-slate-800/50 cursor-pointer group"
                        }`}
                    >
                      <div className="flex items-center gap-3">
                        <Upload
                          className={`w-6 h-6 transition-colors ${!formData.name
                        ...
                        <div>
                          <p
                            className={`text-sm ${!formData.name ? "text-slate-500 dark:text-slate-400 dark:text-slate-600" : "text-slate-500 dark:text-slate-400"
                              }`}
                          >
                            {!formData.name ? (
                  ...
                  <>
                    <div className="relative">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-slate-800 text-slate-500 dark:text-slate-400">OR</span>
                      </div>
                    </div>
                    <input
                      type="text"
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-3 py-2 bg-white dark:bg-slate-900/50 border border-slate-300 dark:border-slate-600 rounded-lg text-sm text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent transition-all resize-none"
                  />
                </div>
                <div>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white dark:bg-slate-900/40 border-2 border-slate-300 dark:border-slate-600 rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-violet-500"
                />
              </div>
              ...
              <div>
                ...
                <button
                  ...
                  className={`w-full px-4 py-3 rounded-lg font-semibold transition-all flex items-center justify-between ${formData.isActive
                      ...
                      : "bg-slate-500/10 border-2 border-slate-500/50 text-slate-500 dark:text-slate-400"
                    }`}
                >
                  ...
                  <div className={`w-11 h-6 rounded-full ${formData.isActive ? "bg-emerald-500" : "bg-slate-300 dark:bg-slate-600"
                    }`}>
                    <div className={`w-5 h-5 bg-white rounded-full transition-all ${formData.isActive ? "translate-x-5 mt-0.5" : "translate-x-0.5 mt-0.5"
                      }`} />
                  </div>
                </button>
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <div className={`w-11 h-6 rounded-full ${formData.showOnHomepage ? "bg-cyan-500" : "bg-slate-300 dark:bg-slate-600"
                    }`}>
                    <div className={`w-5 h-5 bg-white rounded-full transition-all ${formData.showOnHomepage
          ...
          <div className="flex gap-2 pt-3 border-t border-slate-700">
            <button
              ...
              className="flex-1 px-4 py-2.5 bg-slate-200 hover:bg-slate-300 text-slate-800 dark:bg-slate-700 dark:hover:bg-slate-600 dark:text-white rounded-lg text-sm transition-all"
            >
              Cancel
            </button>
